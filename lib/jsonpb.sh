...
#
# jq is a hard runtime dependency. A pure-bash fallback would need a real
# JSON parser (escape handling, string-aware depth tracking, no naive
# substring matching for object/array extraction) — out of scope for shell.
#
# Functions:
